export const CHANGE_PERA_CORD: string = "PERAGRAPH_CORD";
export const PERAGRAPH_CHANGE_ATT: string = "PERAGRAPH_CHANGE_ATT";
export const BACKGROUND_CHANGE_ATT: string = "BACKGROUND_CHANGE_ATT";
